...
<head>
    ...
    background: linear-gradient(135deg, #0f2027, #2c5364, #00d2ff);
    color: #ffffff;
    min-height: 100vh;
    padding-top: 40px;
...
@keyframes highlight {
    0%   { background-color: rgba(0, 255, 174, 0.2); }
...
<div class="container">
    <div class="row">
        <!-- Kolom kiri: Foto & Form -->
        <div class="col-md-4 mb-4">
            <div class="card-custom text-center">
                <h4 class="mb-3">Arjun</h4>
                <img src="arjun.jpg" alt="Foto Arjun" class="profile-img mb-3">
